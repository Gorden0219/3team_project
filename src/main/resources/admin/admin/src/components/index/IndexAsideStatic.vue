  ...
  <div class="menu-preview">
    ...
    <el-scrollbar wrap-class="scrollbar-wrapper">
      <el-menu :default-openeds="[]"
               :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}'
               :unique-opened="true"
               class="el-menu-vertical-demo" default-active="0">
        <el-image v-if="false"
                  :style='{"width":"44px","margin":"10px auto","objectFit":"cover","borderRadius":"100%","display":"block","height":"44px"}'
                  fit="cover" src="http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg"></el-image>
        ...
        <el-submenu index="0" @click.native="menuHandler('')">
          <template slot="title">
            <i v-if='true'
               :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","width":"24px","fontSize":"18px","lineHeight":"1"}'
        ...
        <el-submenu index="1">
          <template slot="title">
            ...
            <span
                :style='{"verticalAlign":"middle","fontSize":"14px","lineHeight":"1.3","color":"inherit"}'>个人中心</span>
          </template>
        ...
        <el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
          <template slot="title">
            <i v-if='true'
               ...
               :style='{"verticalAlign":"middle","margin":"0 3px","color":"inherit","textAlign":"center","width":"24px","fontSize":"18px","lineHeight":"1"}'
               class="el-icon-menu"/>
            <span :style='{"verticalAlign":"middle","fontSize":"14px","lineHeight":"1.3","color":"inherit"}'>{{
                menu.menu
              }}</span>
          </template>
