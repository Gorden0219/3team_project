  ...
  <div class="content">
    ...
    <div class="cardView">
      <div :style='{"margin":"0 0 20px 0","alignItems":"center","justifyContent":"center","display":"flex"}'
           class="cards">
        <div v-if="isAuth('yonghu','首页总数')"
             :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}'>
          ...
          <div
            ...
            <div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>
              用户总数
            </div>
          </div>
        </div>
        <div v-if="isAuth('caipuxinxi','首页总数')"
             :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"0 10px","borderRadius":"4px","display":"flex"}'>
          <div :style='{"width":"80px","background":"#FF8C51","height":"80px"}'></div>
          <div
              :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
      ...
      <div style="display: flex;align-items: center;width: 100%;margin-bottom: 10px;">
        <el-card v-if="isAuth('yonghu','首页统计')" style="width: 50%;margin: 0 10px;">
          <div id="yonghuChart1" style="width:100%;height:400px;"></div>
        </el-card>
        <el-card v-if="isAuth('caipuxinxi','首页统计')" style="width: 50%;margin: 0 10px;">
