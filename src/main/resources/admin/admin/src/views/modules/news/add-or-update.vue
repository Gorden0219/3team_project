<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      ...
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" label="简介"
                    prop="introduction">
        <el-input
      ...
      <el-form-item v-else-if="ruleForm.introduction" :style='{"width":"50%","margin":"0 0 20px 0"}' label="简介"
                    prop="introduction">
        <span
