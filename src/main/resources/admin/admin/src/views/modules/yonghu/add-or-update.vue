  ...
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        ...
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="密码"
                      prop="mima">
          <el-input v-model="ruleForm.mima" :readonly="ro.mima" clearable placeholder="密码"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="密码" prop="mima">
        ...
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" label="性别"
                      prop="xingbie">
        ...
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="性别" prop="xingbie">
          <el-input v-model="ruleForm.xingbie"
                    placeholder="性别" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="邮箱"
                      prop="youxiang">
          <el-input v-model="ruleForm.youxiang" :readonly="ro.youxiang" clearable placeholder="邮箱"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang" placeholder="邮箱" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="手机号码"
                      prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma" :readonly="ro.shoujihaoma" clearable
                    placeholder="手机号码"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="手机号码"
                      prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma" placeholder="手机号码" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info' && !ro.touxiang" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
        ...
        <el-form-item v-else-if="ruleForm.touxiang" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="头像" prop="touxiang">
