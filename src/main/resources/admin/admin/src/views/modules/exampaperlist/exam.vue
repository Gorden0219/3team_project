<template>
  <div class="container">
    <div class="top-content">
      ...
      <div class="right-content">
        <el-button round type="danger" @click="leaveTap">结束考试</el-button>
      </div>
    </div>
    <div v-if="!isEndFlag" class="detail-content">
      ...
      >
        ...
        <span class="content">
          <el-input v-model="answer" clearable placeholder="填写答案" style="width:300px"></el-input>
        </span>
      </div>
      <div
      ...
      <div class="item-content" style="color:#888888">
        <el-button v-if="!isSubmitFlag" type="primary" @click="submitTap">提交答案</el-button>
        <el-button v-if="isSubmitFlag" type="success" @click="nextTap">下一题</el-button>
      </div>
    </div>
    <div v-if="isEndFlag" class="detail-content">
      <div class="item-content">
      ...
      <div class="item-content" style="color:#888888">
        <el-button type="primary" @click="finishTap">结束考试</el-button>
      </div>
    </div>
  </div>
</template>
