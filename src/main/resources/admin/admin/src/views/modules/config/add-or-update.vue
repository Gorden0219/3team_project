  ...
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        ...
        <el-form-item v-if="type!='info' && !ro.value" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="值" prop="value">
          <file-upload
        ...
        <el-form-item v-else-if="ruleForm.value" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="值" prop="value">
