  ...
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        ...
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="标题" prop="title">
          <el-input v-model="ruleForm.title" placeholder="标题" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="副标题"
                      prop="subtitle">
          <el-input v-model="ruleForm.subtitle" :readonly="ro.subtitle" clearable placeholder="副标题"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="副标题"
                      prop="subtitle">
          <el-input v-model="ruleForm.subtitle" placeholder="副标题" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info' && !ro.picture1" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
        ...
        <el-form-item v-else-if="ruleForm.picture1" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="图片1" prop="picture1">
        ...
        <el-form-item v-if="type!='info' && !ro.picture2" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
        ...
        <el-form-item v-else-if="ruleForm.picture2" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="图片2" prop="picture2">
        ...
        <el-form-item v-if="type!='info' && !ro.picture3" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
        ...
        <el-form-item v-else-if="ruleForm.picture3" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="图片3" prop="picture3">
      ...
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="内容" prop="content">
        <editor
      ...
      <el-form-item v-else-if="ruleForm.content" :style='{"width":"50%","margin":"0 0 20px 0"}' label="内容"
                    prop="content">
        <span
