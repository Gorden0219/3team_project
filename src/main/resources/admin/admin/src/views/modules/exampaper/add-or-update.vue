<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input"
                      label="趣味答题名称" prop="name">
          <el-input v-model="ruleForm.name" :readonly="ro.name" clearable placeholder="趣味答题名称"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="趣味答题名称"
                      prop="name">
          <el-input v-model="ruleForm.name" placeholder="趣味答题名称" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input"
                      label="考试时长(分钟)" prop="time">
          <el-input v-model="ruleForm.time" :readonly="ro.time" clearable placeholder="考试时长(分钟)"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="考试时长(分钟)"
                      prop="time">
          <el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="select"
                      label="趣味答题状态" prop="status">
          <el-select v-model="ruleForm.status" :disabled="ro.status" placeholder="请选择趣味答题状态">
            <el-option
        ...
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="趣味答题状态"
                      prop="status">
