<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="用户名"
                      prop="username">
          <el-input v-model="ruleForm.username" clearable placeholder="用户名" readonly></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="用户名"
                      prop="username">
          <el-input v-model="ruleForm.username" placeholder="用户名" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info' && !ro.cpicture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="留言图片" prop="cpicture">
          <file-upload
        ...
        <el-form-item v-else-if="ruleForm.cpicture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="留言图片" prop="cpicture">
          <img v-if="ruleForm.cpicture.substring(0,4)=='http'" v-bind:key="index" :src="ruleForm.cpicture.split(',')[0]"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
          <img v-for="(item,index) in ruleForm.cpicture.split(',')" v-else v-bind:key="index" :src="$base.url+item"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
        </el-form-item>
        <el-form-item v-if="type!='info' && !ro.rpicture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="回复图片" prop="rpicture">
          <file-upload
        ...
        <el-form-item v-else-if="ruleForm.rpicture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="回复图片" prop="rpicture">
          <img v-if="ruleForm.rpicture.substring(0,4)=='http'" v-bind:key="index" :src="ruleForm.rpicture.split(',')[0]"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
          <img v-for="(item,index) in ruleForm.rpicture.split(',')" v-else v-bind:key="index" :src="$base.url+item"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
        </el-form-item>
      </template>
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" label="留言内容"
                    prop="content">
        <el-input
      ...
      <el-form-item v-else-if="ruleForm.content" :style='{"width":"50%","margin":"0 0 20px 0"}' label="留言内容"
                    prop="content">
        <span
      ...
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" label="回复内容"
                    prop="reply">
        <el-input
      ...
      <el-form-item v-else-if="ruleForm.reply" :style='{"width":"50%","margin":"0 0 20px 0"}' label="回复内容"
                    prop="reply">
        <span
            :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{
            ruleForm.reply
