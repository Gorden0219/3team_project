<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="菜品分类"
                      prop="caipinfenlei">
          <el-input v-model="ruleForm.caipinfenlei" :readonly="ro.caipinfenlei" clearable
                    placeholder="菜品分类"></el-input>
        </el-form-item>
