<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="帖子标题"
                      prop="title">
          <el-input v-model="ruleForm.title" :readonly="ro.title" clearable placeholder="帖子标题"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="帖子标题" prop="title">
          <el-input v-model="ruleForm.title" placeholder="帖子标题" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" label="状态"
                      prop="isdone">
          <el-select v-model="ruleForm.isdone" :disabled="ro.isdone" placeholder="请选择状态">
            <el-option
        ...
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="状态" prop="isdone">
          <el-input v-model="ruleForm.isdone"
                    placeholder="状态" readonly></el-input>
        </el-form-item>
      </template>
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="帖子内容" prop="content">
        <editor
      ...
      <el-form-item v-else-if="ruleForm.content" :style='{"width":"50%","margin":"0 0 20px 0"}' label="帖子内容"
                    prop="content">
        <span
