<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="提问"
                      prop="ask">
          <el-input v-model="ruleForm.ask" :readonly="ro.ask" clearable placeholder="提问"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="提问" prop="ask">
          <el-input v-model="ruleForm.ask" placeholder="提问" readonly></el-input>
        </el-form-item>
      </template>
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" label="回复"
                    prop="reply">
        <el-input
      ...
      <el-form-item v-else-if="ruleForm.reply" :style='{"width":"50%","margin":"0 0 20px 0"}' label="回复" prop="reply">
        <span
