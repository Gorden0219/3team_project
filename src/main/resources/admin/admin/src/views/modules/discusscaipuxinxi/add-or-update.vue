<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      ...
      <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" label="评论内容"
                    prop="content">
        <el-input
      ...
      <el-form-item v-else-if="ruleForm.content" :style='{"width":"50%","margin":"0 0 20px 0"}' label="评论内容"
                    prop="content">
        <span
