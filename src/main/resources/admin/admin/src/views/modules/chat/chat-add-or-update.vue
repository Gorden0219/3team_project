    ...
    <el-form
      ...
      <div id="chat-content" class="chat-content">
        <div v-for="item in dataList" v-bind:key="item.id">
          <div v-if="item.ask" class="left-content">
            <el-alert v-if="!item.img" :closable="false" :title="item.ask" class="text-content"
                      type="success"></el-alert>
            <el-image v-if="item.img" :preview-src-list="[imgUrl + item.img]" :src="imgUrl + item.img"
                      fit="scale-down" style="width: 120px;margin: 10px;"></el-image>
          </div>
          <div v-else class="right-content">
            <el-alert v-if="!item.img" :closable="false" :title="item.reply" class="text-content"
      ...
      <el-form-item :style='{"padding":"0","margin":"0 0 20px"}'>
        <div style="width: 100%;display: flex;align-items: center;">
          <img src="../../../assets/img/jiahao.png" style="width: 40px;cursor: pointer;margin-right: 10px;"
          ...
          <el-button
              ...
              type="primary" @click="onSubmit">回复
          </el-button>
          <el-button
