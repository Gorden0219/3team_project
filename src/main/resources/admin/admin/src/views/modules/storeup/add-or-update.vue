<template>
  <div class="addEdit-block" style="width: 100%;">
    ...
    >
      <template>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="名称"
                      prop="name">
          <el-input v-model="ruleForm.name" :readonly="ro.name" clearable placeholder="名称"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="名称" prop="name">
          <el-input v-model="ruleForm.name" placeholder="名称" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info' && !ro.picture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
        ...
        <el-form-item v-else-if="ruleForm.picture" :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload"
                      label="图片" prop="picture">
        ...
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="推荐类型"
                      prop="inteltype">
          <el-input v-model="ruleForm.inteltype" :readonly="ro.inteltype" clearable placeholder="推荐类型"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="推荐类型"
                      prop="inteltype">
          <el-input v-model="ruleForm.inteltype" placeholder="推荐类型" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="type!='info'" :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="备注"
                      prop="remark">
          <el-input v-model="ruleForm.remark" :readonly="ro.remark" clearable placeholder="备注"></el-input>
        </el-form-item>
        <el-form-item v-else :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" label="备注" prop="remark">
