    ...
    <div v-if="!showFlag">
      <el-form
        ...
        <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
          <el-button
              ...
              round type="primary" @click="back()">返回
          </el-button>
        </el-form-item>
      </el-form>
      <div class="table-content">
        ...
        >
          ...
          <el-table-column align="center" header-align="center" label="姓名" prop="username" sortable></el-table-column>
          <el-table-column
              align="center"
              header-align="center"
              label="趣味答题"
          ...
          <el-table-column
              ...
              sortable
          ></el-table-column>
          <el-table-column align="center" header-align="center" label="分值" prop="score" sortable></el-table-column>
          <el-table-column align="center" header-align="center" label="正确答案" prop="answer"
