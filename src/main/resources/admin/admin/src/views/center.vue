<template>
  <div>
    ...
    >
      <el-row>
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" clearable placeholder="账号" readonly></el-input>
        </el-form-item>
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming" clearable placeholder="姓名"></el-input>
        </el-form-item>
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="性别" prop="xingbie">
        ...
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang" clearable placeholder="邮箱"></el-input>
        </el-form-item>
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="手机号码"
                      prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma" clearable placeholder="手机号码"></el-input>
        </el-form-item>
        <el-form-item v-if="flag=='yonghu'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="头像" prop="touxiang">
          <file-upload
        ...
        <el-form-item v-if="flag=='users'" :style='{"width":"50%","margin":"0 0 20px 0"}' label="用户名"
                      prop="username">
        ...
        <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
          <el-button
              ...
              type="primary" @click="onUpdateHandler">修 改
          </el-button>
        </el-form-item>
      </el-row>
    </el-form>
