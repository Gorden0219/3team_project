    ...
    >
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="账号" prop="zhanghao">
        <el-input v-model="ruleForm.zhanghao"
                  clearable placeholder="账号"></el-input>
      </el-form-item>
      ...
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="姓名" prop="xingming">
        <el-input v-model="ruleForm.xingming"
                  clearable placeholder="姓名"></el-input>
      </el-form-item>
      ...
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="邮箱" prop="youxiang">
        <el-input v-model="ruleForm.youxiang"
                  clearable placeholder="邮箱"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="手机号码"
                    prop="shoujihaoma">
        <el-input v-model="ruleForm.shoujihaoma"
                  clearable placeholder="手机号码"></el-input>
      </el-form-item>
