  ...
  <div
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv">
      <div class="section-btn">
        ...
        <el-button icon="el-icon-plus" type="primary" @click="toForumAdd">发布帖子</el-button>
      </div>
    </el-form>
    <div class="z-box">
      <div v-for="item in forumList" :key="item.id" class="section-content" @click="toForumDetail(item)">
