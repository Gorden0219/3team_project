<template>
  <div
    ...
    <div class="section-content">
      ...
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          ...
          <el-button icon="el-icon-plus" style="float: right;" type="success" @click="dialogFormVisible = true">
            点击评论
          </el-button>
        </div>
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="添加评论">
      <el-form ref="form" :model="form" :rules="rules">
        <el-form-item label="评论" label-width="60px" prop="content">
          <el-input v-model="form.content" :rows="5" autocomplete="off" placeholder="请输入评论"
