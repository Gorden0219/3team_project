<template>
  <div
      :style='{"border":"2px solid #dbd9f4","padding":"20px","margin":"10px auto","borderRadius":"8px","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
        ref="ruleForm"
        :model="ruleForm"
        :rules="rules"
        ...
        label-width="80px"
    >
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜谱名称"
                    prop="caipumingcheng">
        <el-input v-model="ruleForm.caipumingcheng"
                  clearable placeholder="菜谱名称"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜品分类"
                    prop="caipinfenlei">
      ...
      <el-form-item v-if="type!='cross' || (type=='cross' && !ro.caipufengmian)"
                    :style='{"padding":"10px","margin":"0 0 10px","background":"0"}'
      ...
      <el-form-item v-else :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' class="upload"
                    label="菜谱封面" prop="caipufengmian">
        ...
        <img v-for="(item,index) in ruleForm.caipufengmian.split(',')" v-else v-bind:key="index" :src="baseUrl+item"
             class="upload-img" height="100" style="margin-right:20px;" width="100">
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="口味" prop="kouwei">
        <el-input v-model="ruleForm.kouwei"
                  clearable placeholder="口味"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="材料" prop="cailiao">
        <el-input v-model="ruleForm.cailiao"
                  clearable placeholder="材料"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="制作工艺"
                    prop="zhizuogongyi">
        <el-input v-model="ruleForm.zhizuogongyi"
                  clearable placeholder="制作工艺"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="适应人群"
                    prop="shiyingrenqun">
        <el-input v-model="ruleForm.shiyingrenqun"
                  clearable placeholder="适应人群"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="功效营养"
                    prop="gongxiaoyingyang">
        <el-input v-model="ruleForm.gongxiaoyingyang"
                  clearable placeholder="功效营养"></el-input>
      </el-form-item>
      <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜谱详情"
                    prop="caipuxiangqing">
        <editor
      ...
      <el-form-item :style='{"padding":"0","margin":"0"}'>
        <el-button
            :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 25%","outline":"none","color":"#666","borderRadius":"10px","background":"linear-gradient(90deg, rgba(255,233,100,1) 0%, rgba(194,248,126,1) 29%, rgba(181,233,252,1) 61%, rgba(246,172,218,1) 100%)","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}'
            type="primary" @click="onSubmit">提交
        </el-button>
        <el-button
            :style='{"border":"2px solid rgba(213, 203, 235, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#000","borderRadius":"4px","background":"rgba(255, 255, 255, 1)","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}'
            @click="back()">返回
        </el-button>
      </el-form-item>
    </el-form>
